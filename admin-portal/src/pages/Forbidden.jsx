...
export default function Forbidden() {
  ...
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center text-center px-6">
      <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-linear-to-br from-brand-800 to-brand-950">
      ...
      <p className="mt-2 max-w-sm text-body text-fg-muted">
        Your role doesn't have permission to view this page. If you think that's
